...
function mongoListeners() {
    mongoose.connection.on('disconnected', () => {
        console.warn('Mongo: Disconnected from the Database.');
    });

    mongoose.connection.on('connecting', () => {
        console.info('Mongo: Trying to Connect to Database...');
    });

    mongoose.connection.on('connected', () => {
        console.info('Mongo: Database Connection Successfully Opened.');
    });

    mongoose.connection.on('reconnected', () => {
        console.info('Mongo: Database Connection Successfully Reconnected.');
    });
