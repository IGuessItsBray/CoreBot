...
CoreBot is a multipurpose discord bot made by Bray! It features music, moderation, role buttons, and more!
        ...
        title: "About",
        footer: "Made with ♥️ by Bray, Seth and the CBDev team!",
      },
      { title: "Commands", content: commandsFormatted.join("\n\n") },
      {
        content: `**Up Since** <t:${Math.floor(
      ...
      },
      {
        content: `For support, pop into the CoreBot Development support server:
            [CoreBot Support server](https://discord.gg/PW7VzKtGSn)`,
        title: "Support",
        footer: "CoreBot",
      },
      {
        content: `${this.formatThanks()}`,
      ...
      {
        content: `[View the privacy policy for all CoreBot Services](https://privacy.brayd.net)`,
        title: "Privacy Policy",
        footer: "CoreBot",
      },
      {
        content: `[Coming Soon™️](https://tos.brayd.net)`,
