...
module.exports = {
  ...
  name: "jumbo",
  description: "Make your emotes big!",
  ...
  async execute(interaction) {
    ...
    rawEmotes.forEach((e) => {
      if (/\d+?/.test(e))
        files.push({ attachment: `https://cdn.discordapp.com/emojis/${e}` });
      else
        files.push({
          attachment: `https://twemoji.maxcdn.com/v/latest/72x72/${e
            .codePointAt(0)
            .toString(16)}.png`,
        });
    });
    ...
    if (!files.length)
      await interaction.reply({
        ephemeral: true,
        content: "You need to send an emote!",
      });
