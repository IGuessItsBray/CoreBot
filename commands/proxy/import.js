...
module.exports = {
    ...
    async execute(interaction, client, ephemeral = true) {
        ...
        if (attachment !== null) {
            ...
            if (!attachment.contentType.startsWith('application/json')) return await interaction.reply({
            ...
            system.members.forEach(async member => {
                ...
                const tags = member.proxy_tags.map(x => x.prefix).find(innerArr => innerArr?.length > 0);
